...
export const metadata: Metadata = {
  ...
  description: 'Why ADHD brains are wired for impulsive purchases — and how to create friction that actually works.',
}
    ...
    <div className="min-h-screen bg-white">
      <div className="bg-gradient-to-br from-brand-900 to-brand-700 text-white py-16 px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl font-black mb-4 leading-tight">ADHD and Impulse Spending</h1>
          <p className="text-xl text-brand-100">Why ADHD brains are wired for impulsive purchases — and how to create friction that actually works.</p>
        </div>
      </div>
