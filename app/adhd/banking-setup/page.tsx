...
export const metadata: Metadata = {
  ...
  description: 'Automate everything. Remove decisions. Set up an account structure that runs on autopilot.',
}
    ...
    <div className="min-h-screen bg-white">
      <div className="bg-gradient-to-br from-brand-900 to-brand-700 text-white py-16 px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl font-black mb-4 leading-tight">The ADHD-Proof Banking Setup</h1>
          <p className="text-xl text-brand-100">Automate everything. Remove decisions. Set up an account structure that runs on autopilot.</p>
        </div>
      </div>
