...
export const metadata: Metadata = {
  title: 'Late Payment Recovery Guide — DIY Credit Fix',
  description: 'How to dispute late payments, write goodwill deletion letters, and prevent it from happening again.',
}
    ...
    <div className="min-h-screen bg-white">
      <div className="bg-gradient-to-br from-brand-900 to-brand-700 text-white py-16 px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl font-black mb-4 leading-tight">Late Payment Recovery Guide</h1>
          <p className="text-xl text-brand-100">How to dispute late payments, write goodwill deletion letters, and prevent it from happening again.</p>
        </div>
      </div>
